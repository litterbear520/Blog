...
const MESSAGES_PER_STEP = [
  [],
  [{ role: "user", detail: "Fix the login bug", color: "#2a78d6" }],
  [],
...
function getPalette(isDark) {
  if (isDark) {
    return {
      ...
      nodeStroke: "#3f3f46",
      nodeText: "#d4d4d8",
      activeNodeFill: "#2a78d6",
      activeNodeStroke: "#3987e5",
      activeNodeText: "#ffffff",
      endNodeFill: "#7c3aed",
      endNodeStroke: "#a855f7",
      edgeStroke: "#52525b",
      activeEdgeStroke: "#6da7ec",
      arrowFill: "#71717a",
      labelFill: "#a1a1aa",
      iterFill: "#6da7ec",
      svgBg: "#0a0a0b",
      ...
      annotationBg: "rgba(42,120,214,0.12)",
      annotationBorder: "#0d366b",
      annotationTitle: "#6da7ec",
      annotationDesc: "#9ec5f4",
      btnBorder: "#27272a",
      btnColor: "#71717a",
      btnHoverBg: "#18181b",
  ...
  return {
    ...
    nodeText: "#475569",
    activeNodeFill: "#2a78d6",
    activeNodeStroke: "#256abf",
    activeNodeText: "#ffffff",
    endNodeFill: "#7c3aed",
    endNodeStroke: "#a855f7",
    edgeStroke: "#cbd5e1",
    activeEdgeStroke: "#2a78d6",
    arrowFill: "#94a3b8",
    labelFill: "#94a3b8",
    iterFill: "#184f95",
    svgBg: "#f8fafc",
    ...
    annotationBg: "rgba(42,120,214,0.1)",
    annotationBorder: "#86b6ef",
    annotationTitle: "#184f95",
    annotationDesc: "#1c5cab",
    btnBorder: "#e2e8f0",
    btnColor: "#94a3b8",
    btnHoverBg: "#f1f5f9",
          ...
          <div className={styles.dots}>
            {Array.from({ length: totalSteps }, (_, i) => (
              <div key={i} className={styles.dot} style={{
                backgroundColor: i === currentStep ? "#2a78d6" : i < currentStep ? p.dotPast : p.dotInactive,
              }} />
            ))}
          </div>
