...
```markdown
If you need more information from me, ask me any clarifying questions you need (one at a time) until you are 95% confident you can complete the task. If you think I should give you more context or upload anything to help you do a better job, let me know. Use any tools you have access to—like Google Drive, web search, etc.—if they'll help.
...
- When running as Codex on Windows, always execute commands in Bash through Python subprocess, never PowerShell; otherwise, ignore this rule.
