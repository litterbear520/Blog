...
在这个AI发展迅猛的时代，我们都沉浸在AI带给我们的惊喜中。

看着手机上安装的大模型APP，写代码时打开的Cursor，在命令行打开的Claude Code以及盯着Notebooklm里面的笔记发呆。这种感觉，真的说不出来，那种拥有全世界，似乎能够解决任何不懂的难题，这让我有时候很浮躁，失去了平静学习的能力。

有一天我心血来潮，打算看一下Langchain的官方文档，想一探究竟现在的大热门框架的底层原理，但当我打开概述阅读完第一页后我看到了一个小提示，我愣神了一晚上，最终关闭了文档。

这个提示是这样的：

![1766152136515](image/index/1766152136515.png)

我绝望了，在冰冷的大模型面前，自己是那么的渺小，AI就像一个我永远无法追上的怪物，望尘莫及。

当然我很快回过神来，既然无法触及，那就成为AI的朋友，去接纳它，在使用AI的过程中，提升自己。

未来，我也希望能够深耕AI智能体这条路，去拥抱AI，这是时代的机遇。

感兴趣可以看原文：[B端智能体落地的一万字复盘](https://waytoagi.feishu.cn/wiki/Ogruwnwppi3THCkK9Q4cdKrRnKb)

这篇文章对迷茫的我启发很大，我担心有一天这篇文章会下架，于是记录到我的笔记中。
...
但这里有个常见错觉：**"能回答就行"。实际交付里，70分系统只能算 Demo，企业要的是逼近专家水准的稳定性。做到70分很容易，但要到90分极难**。
...
第三个关键点是Query 重写。用户的问题往往口语化、不精准，你得把它改写成更适合检索的形式，这一步对召回质量影响巨大。
...
你只要在交付现场待过，就会发现这才是决定项目成败的总开关。技术反而是相对简单的部分——大模型能力摆在那里，工作流平台也很成熟。难的是如何让企业理解AI能做什么、不能做什么，如何把他们脑子里的专家知识变成可执行的系统流程。

这就是B端智能体落地的现状——机会很大，坑也很多，关键看你能不能找对路径。

## 3.“好用、能落地”的智能体本质：专家知识 × 技术放大
...
## 4.先分清两类东西——自主规划 Agent vs AI 工作流
...
其实目前自主规划型 Agent 真正稳定可落地的场景其实就两个。第一个是 Deep Research（深度调研），把散乱的信息整理成可决策的结构化报告，这个场景GPT还是断崖式领先。第二个是 AI Coding（代码生成），因为代码能在工程环境里自我校验，有测试闭环，所以可控性远高于其他场景。

除了这两个场景，自主规划型 Agent 在 B 端多数场景还停留在 Demo 区，不是生产区。

### AI 工作流是什么

AI 工作流走的是另一条路。人先把专家 SOP 画好：第1步做啥、第2步做啥、每步输入输出是什么，清清楚楚。模型只是流程里的一个"可替换节点"，按既定链路执行。
...
智能体其实是一场认知革命——谁能把人类专家的隐性知识显性化、把显性知识工程化、把工程化的东西产品化，谁才能真正立足。
